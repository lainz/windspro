---------------------------------------------------------------
---------------------------------------------------------------
windsproskin_nombre = "Android Ice Cream Sandwich"
---------------------------------------------------------------
windsproskin_sonido_highlight = ""
windsproskin_sonido_click = "Betelgeuse.ogg"
---------------------------------------------------------------
...
---------------------------------------------------------------
windsproskin_fuente = "Droid Sans"
...
System.RegisterFont(_SourceFolder.."windspro\\skins\\"..windsproskin_nombre.."\\".."DroidSans.ttf", "Droid Sans", true)
...
skn_menu_windspro.ButtonFile = "windspro\\skins\\"..windsproskin_nombre.."\\"..windsproskin_boton
skn_menu_windspro.FontName = windsproskin_fuente
skn_menu_windspro.FontSize = windsproskin_fuente_size
skn_menu_windspro.X = 0
skn_menu_windspro.Y = 0
skn_menu_windspro.Width = 139
skn_menu_windspro.Height = 36
