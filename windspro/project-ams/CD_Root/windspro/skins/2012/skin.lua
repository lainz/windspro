---------------------------------------------------------------
---------------------------------------------------------------
windsproskin_nombre = "2012"
---------------------------------------------------------------
windsproskin_sonido_highlight = "highlight.wav"
windsproskin_sonido_click = "click.wav"
---------------------------------------------------------------
windsproskin_fondo = "fondo.png"
windsproskin_barra = "barra.png"
---------------------------------------------------------------
windsproskin_mostrar_barra = false
windsproskin_mostrar_cambiar_fondo = true
---------------------------------------------------------------
windsproskin_boton = "boton.btn"
windsproskin_extra = "stab.btn"
---------------------------------------------------------------
